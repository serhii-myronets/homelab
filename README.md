...
[`docs/INVENTORY.md`](docs/INVENTORY.md) describes the hardware and network
either side of it; [`docs/DECISIONS.md`](docs/DECISIONS.md) records why the
setup is shaped the way it is, and what is still open.
