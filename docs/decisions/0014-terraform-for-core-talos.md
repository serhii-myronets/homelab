...
The owner chose Terraform for bare-metal cluster configuration application,
initial bootstrap and client credentials. YAML patches remain reviewable
inputs. Application deployments will live separately.
